...
如：view-source:https://www.kaoyan.cn
"""
...
class COVID_19(object):
    ...
    def crawl_last_day_COVID19(self):  # 抓取信息
        ...
        # 3. 保存
        self.save(last_day_COVID19, '../COV_data/last_day_COVID19.json')
    ...
    def crawl_COVID19(self):
        ...
        """
        # 1. 加载各国疫情数据
        with open('../COV_data/last_day_COVID19.json', encoding='utf-8') as fp:
